...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
    ...
    <script
    src="https://cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.19.1/js/jquery.iframe-transport.min.js"></script>
    <script
    src="https://cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.19.1/js/jquery.fileupload.min.js"></script>
    <script
    src="https://cdnjs.cloudflare.com/ajax/libs/blueimp-file-upload/9.19.1/js/vendor/jquery.ui.widget.min.js"></script>
    <script
    src="https://cdnjs.cloudflare.com/ajax/libs/cloudinary-jquery-file-upload/2.3.0/cloudinary-jquery-file-upload.min.js"></script> 
...
<form:form method="POST" action="${formAction}" modelAttribute="newBeer">
	...
	<div class="row">
		...
		<div class="col-sm-4">
			...
			<div class="form-group">
				<label for="type">Beer Style: </label>
				<form:input path="type" placeHolder="Beer Style"
					class="form-control" />
				<form:errors path="type"></form:errors>
			</div>
			<div class="form-group">
				<label for="info">Description: </label>
				<form:input path="info" placeHolder="Description"
					class="form-control" />
			...
			<div class="form-group">
				...
				<input name="file" type="file" class="cloudinary-fileupload"
					data-cloudinary-field="imgUrl"
					data-form-data="{&quot;upload_preset&quot;: &quot;brewery_images&quot; }"></input>
				<form:errors path="imgUrl"></form:errors>
			</div>
			<div>
				<button type="submit" class="btn btn-default addBreweryButton">Add
					New Beer</button>
				<br>
			</div>
		</div>
