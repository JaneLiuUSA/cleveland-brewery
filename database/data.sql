...
INSERT INTO breweries (name, address, city, zipcode, phone_number, description, brewery_logo_url, website_url, business_hours, user_id)
VALUES ('Great Lakes Brewery', '2516 Market Ave.', 'Cleveland', 44113, '(216) 771-4404', 'Cleveland`s premier brewery','http://localhost:8080/capstone/img/GLBC_logo-centered-710x412.png', 'https://www.greatlakesbrewing.com',
